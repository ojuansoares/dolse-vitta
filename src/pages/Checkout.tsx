...
export default function Checkout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { whatsapp_number, whatsapp_message } = response
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center gap-4 mb-8 animate-fade-in">
        <Link to="/carrinho" className="p-2 rounded-xl hover:bg-brown-500/10 transition-apple">
      ...
      >
        ...
        <button
          ...
          className={cn(
            ...
            "hover:bg-green-600 transition-apple",
